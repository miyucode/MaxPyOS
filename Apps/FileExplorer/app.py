...
def fileexplorer():
	...
	def copy_file():
		file_to_copy = fd.askopenfilename(title='Choose a file to copy', filetypes=[("All files", "*.*")], initialdir="System/Users/Admin/Desktop")
		dir_to_copy_to = fd.askdirectory(title="In which folder to copy to?", initialdir="System/Users/Admin/Desktop")
		try:
	...
	def delete_file():
		file = fd.askopenfilename(title='Choose a file to delete', filetypes=[("All files", "*.*")], initialdir="System/Users/Admin/Desktop")
	...
	def open_file():
		file = fd.askopenfilename(title='Choose a file of any type', filetypes=[("All files", "*.*")], initialdir="System/Users/Admin/Desktop")
	...
	file.add_command(label="Create a new text file", command=newtextfile)
